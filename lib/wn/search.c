...
// modified by Xin for backward compatibility
SynsetPtr findtheinfo_ds(char *searchstr, int dbase, int ptrtyp, int whichsense)
{
	return findtheinfo_ds2(searchstr, dbase, ptrtyp, whichsense, 0);
}

// Xin added depth param to give the option to trace all synset in ptrlist chain
SynsetPtr findtheinfo_ds2(char *searchstr, int dbase, int ptrtyp, int whichsense, int depth2)
{
    IndexPtr idx;
    SynsetPtr cursyn;
